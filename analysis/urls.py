...
urlpatterns = [
    ...
    path('api/user-reports/', views.get_user_reports_api, name='get_user_reports_api'),
    path('api/report/<int:report_id>/', views.get_report_data, name='get_report_data_api'),
